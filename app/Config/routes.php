 ...
 */
	...
	Router::connect('/posts/myposts', array('controller' => 'posts', 'action' => 'myposts','draft'));
	...
	Router::connect('/fblogin/*', array('plugin' => 'users', 'controller' => 'users', 'action' => 'fblogin'));
	Router::connect('/search/*', array('plugin' => '', 'controller' => 'pages', 'action'=>'search'));
